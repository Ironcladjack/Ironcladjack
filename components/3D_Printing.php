...
<script>
  ...
  <div class="container-fluid">
    ...
    <h2>The Printer</h3>
      ...
      <div class="clearfix centre-div">
        <img class="centre-image" src="./static/anet_placeholder2.jpg" alt="Anet A8 Overview"/>
        <img class="centre-image" src="./static/anet_placeholder.jpg" alt="Anet A8 Overview"/>
      </div>
      <p> This is the first 3D printer i've owned, although i did get the opportunity to use some in the Engineering Department of my University as part of my Engineering Degree,
        ...
        <br>
        <br><a href="index.html#!/3D_Printing#Upgrades">Upgrades I've done.</a>
      </p>
